...
const skills = [
    ...
    {
      image: 'https://v33.openhab.org/logos/jdbc.png',
      name: 'JDBC'
    },
    {
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const certificates = [
      { title: "Java Full-Stack", issuer: "Besant Technologies", date: "Jul 2024 - Dec 2024"},
      { title: "Aptitude Skill Development Training Program", issuer: "Nandi Foundation", date: "Jan 2024"},
      { title: "Coding Contest (Participation)", issuer: "Sudharsan College", date: "Mar 2023"},
  ];
